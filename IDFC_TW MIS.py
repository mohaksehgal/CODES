...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 26 08:54:56 2020
...
A=pd.read_excel(r"/Users/mohaksehgal/Documents/Work/MIS/IDFC TW/JUN 21/IDFC_TW ALLOCATION 21 JUN 21.xlsx")

B=pd.read_excel(r"/Users/mohaksehgal/Documents/Work/MIS/IDFC TW/JUN 21/IDFC_TW PAID FILE 22 JUN 21.xlsx")
...
F.rename({'FLOW':'FLOW_CASES','SB':'SB_CASES','RB':'RB_CASES','FORECLOSE':'FORECLOSE_CASES','SETTLEMENT':'SETTLEMENT_CASES','NM':'NM_CASES','PART PAID':'PART_PAID_CASES','RT':'RT_CASES'},axis=1,inplace=True)
...
F.rename({'FLOW':'FLOW_POS','SB':'SB_POS','RB':'RB_POS','FORECLOSE':'FORECLOSE_POS', 'NM':'NM_POS','SETTLEMENT':'SETTLEMENT_POS','PART PAID':'PART_PAID_POS','RT':'RT_POS'},axis=1,inplace=True)
...
F.to_excel(r'/Users/mohaksehgal/Documents/Work/MIS/IDFC TW/JUN 21/MIS IDFC TW.xlsx',index=False)

F.replace(np.nan,0,inplace=True)

F.to_excel(r'/Users/mohaksehgal/Documents/Work/Billing/IDFC TW/IDFC TW Jun 21/Performance TW.xlsx',index=False)
...
A.to_excel(r'/Users/mohaksehgal/Documents/Work/Billing/IDFC TW/IDFC TW Jun 21/MASTER FILE IDFC TW.xlsx',index=False)

A.to_excel(r'/Users/mohaksehgal/Documents/Work/TC Performance/IDFC TW/JUN 21/MASTER FILE IDFC TW.xlsx',index=False)

A.to_excel(r'/Users/mohaksehgal/Documents/Work/MIS/IDFC TW/JUN 21/MASTER FILE IDFC TW.xlsx',index=False)

A.to_excel(r'/Users/mohaksehgal/Documents/Work/FOS Salary/IDFC TW/JUN 21/MASTER FILE IDFC TW.xlsx',index=False)

A.to_excel(r'/Users/mohaksehgal/Documents/Work/TC Incentive/IDFC_TW/JUN 21/MASTER FILE IDFC TW.xlsx',index=False)