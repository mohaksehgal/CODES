...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 26 07:53:16 2020
...
A=pd.read_excel(r"/Users/mohaksehgal/Documents/Work/FOS Salary/L_T/MARCH 20/MASTER FILE L_T.xlsx")

A1=pd.read_excel(r'/Users/mohaksehgal/Documents/Work/MIS/L_T/MARCH 20/L_T PAID FILE 26 MAR 20.xlsx')

TC=pd.DataFrame(A.groupby('FOS')['AGREEMENTID'].count()).reset_index()

TC.to_excel(r'/Users/mohaksehgal/Documents/Work/COMBINED SALARY OF L_T AND IDFC TW/MARCH 20/L_T CASES.xlsx',index=False)

a=list(A1[A1['BKT'].isnull()].index)

A1.drop(a,inplace=True)
...
for i in range(0,len(F['FOS'])):
    ...
    if F.loc[i,'Performance']>=60 and F.loc[i,'Performance']<70:
...
F.to_excel(r'/Users/mohaksehgal/Documents/Work/COMBINED SALARY OF L_T AND IDFC TW/MARCH 20/PAYOUT L_T.xlsx',index=False)

F.to_excel(r'/Users/mohaksehgal/Documents/Work/FOS Salary/L_T/MARCH 20/FOS PERFORMANCE L_T.xlsx',index=False)
